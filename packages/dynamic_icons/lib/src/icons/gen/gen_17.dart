...
const DynamicIconData kRockingChairIcon = DynamicIconData(
...
const DynamicIconData kRollerCoasterIcon = DynamicIconData(
...
const DynamicIconData kRotateCcwIcon = DynamicIconData(
...
const DynamicIconData kRouteIcon = DynamicIconData(
  duration: Duration(milliseconds: 1200),
  parts: [
    IconPart(
...
const DynamicIconData kRouterIcon = DynamicIconData(
...
const DynamicIconData kRussianRubleIcon = DynamicIconData(
...
const DynamicIconData kSatelliteDishIcon = DynamicIconData(
  duration: Duration(milliseconds: 1500),
  parts: [
    IconPart.group(
      ['M4 10a7.31 7.31 0 0 0 10 10Z', 'm9 15 3-3'],
      CompositePart([
...
const DynamicIconData kSaudiRiyalIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const DynamicIconData kScanFaceIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart(
...
const DynamicIconData kScanTextIcon = DynamicIconData(
...
const DynamicIconData kSettingsIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kShieldCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
...
const DynamicIconData kShipIcon = DynamicIconData(
  duration: Duration(milliseconds: 1200),
  repeats: true,
  parts: [
    IconPart(
...
const DynamicIconData kShowerHeadIcon = DynamicIconData(
...
const DynamicIconData kShrinkIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kSlidersHorizontalIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const DynamicIconData kSmartphoneChargingIcon = DynamicIconData(
  duration: Duration(milliseconds: 1000),
  repeats: true,
  parts: [
    IconPart(
...
const DynamicIconData kSmartphoneNfcIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kSmileIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  parts: [
    IconPart(
...
const DynamicIconData kSmilePlusIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const List<IconEntry> gen17Icons = [
  IconEntry('rocking-chair', kRockingChairIcon, [
    'chair',
    'rock',
    'relax',
    'furniture',
  ]),
  IconEntry('roller-coaster', kRollerCoasterIcon, [
    'ride',
    'amusement',
    'park',
    'theme',
  ]),
  IconEntry('rotate-ccw', kRotateCcwIcon, [
    'rotate',
    'undo',
    'refresh',
    'counter-clockwise',
  ]),
  IconEntry('route', kRouteIcon, ['path', 'navigation', 'directions', 'map']),
  IconEntry('router', kRouterIcon, ['network', 'wifi', 'modem', 'internet']),
  IconEntry('russian-ruble', kRussianRubleIcon, [
    'currency',
    'money',
    'ruble',
    'rouble',
  ]),
  IconEntry('satellite-dish', kSatelliteDishIcon, [
    'signal',
    'antenna',
    'receiver',
    'space',
  ]),
  IconEntry('saudi-riyal', kSaudiRiyalIcon, [
    'currency',
    'money',
    'riyal',
    'sar',
  ]),
  IconEntry('scan-face', kScanFaceIcon, [
    'face',
    'biometric',
    'recognition',
    'id',
  ]),
  IconEntry('scan-text', kScanTextIcon, ['ocr', 'text', 'document', 'read']),
  IconEntry('settings', kSettingsIcon, [
    'gear',
    'cog',
    'preferences',
    'options',
  ]),
  IconEntry('shield-check', kShieldCheckIcon, [
    'security',
    'protected',
    'verified',
    'safe',
  ]),
  IconEntry('ship', kShipIcon, ['boat', 'sea', 'vessel', 'cruise']),
  IconEntry('shower-head', kShowerHeadIcon, [
    'bath',
    'water',
    'bathroom',
    'wash',
  ]),
  IconEntry('shrink', kShrinkIcon, [
    'minimize',
    'collapse',
    'compress',
    'smaller',
  ]),
  IconEntry('sliders-horizontal', kSlidersHorizontalIcon, [
    'filter',
    'settings',
    'controls',
    'adjust',
  ]),
  IconEntry('smartphone-charging', kSmartphoneChargingIcon, [
    'phone',
    'battery',
    'charge',
    'mobile',
  ]),
  IconEntry('smartphone-nfc', kSmartphoneNfcIcon, [
    'phone',
    'nfc',
    'contactless',
    'mobile',
  ]),
  IconEntry('smile', kSmileIcon, ['happy', 'emoji', 'face', 'emotion']),
  IconEntry('smile-plus', kSmilePlusIcon, [
    'add',
    'reaction',
    'emoji',
    'happy',
