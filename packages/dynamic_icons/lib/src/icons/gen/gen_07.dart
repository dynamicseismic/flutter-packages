...
const DynamicIconData kConciergeBellIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart.group(
      ['M20 16a8 8 0 1 0-16 0', 'M10 4h4', 'M12 4v4'],
      RotatePart(
        [0, -2, 2, -2, 2, -1, 1, 0],
        pivot: Offset(12, 16),
...
const DynamicIconData kConnectIcon = DynamicIconData(
...
const DynamicIconData kConstructionIcon = DynamicIconData(
...
const DynamicIconData kContrastIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart(
      ...
      RotatePart(
        [0, 180],
        pivot: Offset(6, 12),
        curve: SpringCurve(stiffness: 80, damping: 12),
      ),
    ),
  ],
);
...
const DynamicIconData kCookingPotIcon = DynamicIconData(
...
const DynamicIconData kCopyIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kCornerDownRightIcon = DynamicIconData(
...
const DynamicIconData kCornerLeftDownIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCornerLeftUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCornerRightDownIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCornerRightUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCornerUpLeftIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCornerUpRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart.group(
...
const DynamicIconData kCpuIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kCreditCardIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart.group([
...
const DynamicIconData kCupSodaIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
...
const DynamicIconData kCursorClickIcon = DynamicIconData(
  ...
  parts: [
    IconPart(
      ...
      TranslatePart([Offset.zero, Offset(0, -4), Offset(-3, 0), Offset.zero]),
    ),
    IconPart(
      'M14 4.1 12 6',
      OpacityPart(
...
const DynamicIconData kDatabaseBackupIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const DynamicIconData kDeleteIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
      ['M3 6h18', 'M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2'],
      TranslatePart([
        Offset.zero,
        Offset(0, -1.1),
      ], curve: SpringCurve(stiffness: 500, damping: 30)),
...
const DynamicIconData kDisc3Icon = DynamicIconData(
...
const List<IconEntry> gen07Icons = [
  IconEntry('concierge-bell', kConciergeBellIcon, [
    'bell',
    'service',
    'hotel',
    'reception',
  ...
  IconEntry('connect', kConnectIcon, [
    'plug',
    'socket',
    'link',
    'join',
  ...
  IconEntry('construction', kConstructionIcon, [
    'barrier',
    'roadblock',
    'warning',
    'work',
  ...
  IconEntry('contrast', kContrastIcon, [
    'circle',
    'brightness',
    'display',
    'half',
  ...
  IconEntry('cooking-pot', kCookingPotIcon, [
    'pot',
    'cook',
    'kitchen',
    'food',
  ...
  IconEntry('corner-down-right', kCornerDownRightIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-left-down', kCornerLeftDownIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-left-up', kCornerLeftUpIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-right-down', kCornerRightDownIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-right-up', kCornerRightUpIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-up-left', kCornerUpLeftIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('corner-up-right', kCornerUpRightIcon, [
    'arrow',
    'corner',
    'direction',
    'turn',
  ]),
  IconEntry('cpu', kCpuIcon, [
    'processor',
    'chip',
    'hardware',
    'computer',
  ...
  IconEntry('credit-card', kCreditCardIcon, [
    'payment',
    'card',
    'money',
    'bank',
  ...
  IconEntry('cup-soda', kCupSodaIcon, [
    'drink',
    'soda',
    'beverage',
    'cup',
  ...
  IconEntry('cursor-click', kCursorClickIcon, [
    'pointer',
    'click',
    'mouse',
    'select',
  ...
  IconEntry('database-backup', kDatabaseBackupIcon, [
    'database',
    'backup',
    'restore',
    'data',
  ...
  IconEntry('disc-3', kDisc3Icon, ['disc', 'cd', 'vinyl', 'music', 'record']),
];
