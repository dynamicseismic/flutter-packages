...
const DynamicIconData kMicOffIcon = DynamicIconData(
...
const DynamicIconData kMinimizeIcon = DynamicIconData(
...
const DynamicIconData kMonitorCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
    ...
    IconPart('M12 17v4'),
    IconPart('M8 21h8'),
    IconPart('m9 10 2 2 4-4', CompositePart([DrawPart(), _fadeIn])),
  ],
);

/// NFC signal arcs that flicker out then ripple back in from the inside.
const DynamicIconData kNfcIcon = DynamicIconData(
...
const DynamicIconData kPanelLeftCloseIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kPanelLeftOpenIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z',
...
const DynamicIconData kPanelRightOpenIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z',
...
const DynamicIconData kPartyPopperIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart.group([
...
const DynamicIconData kPauseIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kPenToolIcon = DynamicIconData(
...
const DynamicIconData kPhilippinePesoIcon = DynamicIconData(
...
const DynamicIconData kPhoneIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kPhoneCallIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'M13 2a9 9 0 0 1 9 9',
...
const DynamicIconData kPhoneForwardedIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'M14 6h8',
...
const DynamicIconData kPhoneIncomingIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart.group(
      ['M16 2v6h6', 'm22 2-6 6'],
...
const DynamicIconData kPhoneMissedIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart.group(['m16 2 6 6', 'm22 2-6 6'], ScalePart([1, 1.2, 1])),
    IconPart(
      'M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384',
...
const DynamicIconData kPhoneOffIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kPickaxeIcon = DynamicIconData(
...
const DynamicIconData kPlayIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'M6 3 L20 12 L6 21 L6 3 Z',
      CompositePart([
        TranslatePart([Offset.zero, Offset(-1, 0), Offset(2, 0), Offset.zero]),
...
const DynamicIconData kPlugZapIcon = DynamicIconData(
  duration: Duration(milliseconds: 1000),
  repeats: true,
  parts: [
    IconPart(
    ...
    IconPart('m18 3-4 4h6l-4 4', OpacityPart([1, 0.4, 1])),
  ],
);

const List<IconEntry> gen15Icons = [
  IconEntry('mic-off', kMicOffIcon, ['microphone', 'mute', 'audio']),
  IconEntry('minimize', kMinimizeIcon, ['shrink', 'collapse', 'window']),
  IconEntry('monitor-check', kMonitorCheckIcon, ['screen', 'display', 'done']),
  IconEntry('nfc', kNfcIcon, ['contactless', 'wireless', 'tap']),
  IconEntry('panel-left-close', kPanelLeftCloseIcon, [
    'sidebar',
    'collapse',
    'layout',
  ]),
  IconEntry('panel-left-open', kPanelLeftOpenIcon, [
    'sidebar',
    'expand',
    'layout',
  ]),
  IconEntry('panel-right-open', kPanelRightOpenIcon, [
    'sidebar',
    'expand',
    'layout',
  ]),
  IconEntry('party-popper', kPartyPopperIcon, [
    'celebrate',
    'confetti',
    'party',
  ]),
  IconEntry('pause', kPauseIcon, ['media', 'player', 'stop']),
  IconEntry('pen-tool', kPenToolIcon, ['draw', 'vector', 'edit']),
  IconEntry('philippine-peso', kPhilippinePesoIcon, [
    'currency',
    'money',
    'php',
  ]),
  IconEntry('phone', kPhoneIcon, ['call', 'telephone', 'contact']),
  IconEntry('phone-call', kPhoneCallIcon, ['call', 'ring', 'telephone']),
  IconEntry('phone-forwarded', kPhoneForwardedIcon, [
    'call',
    'forward',
    'redirect',
  ]),
  IconEntry('phone-incoming', kPhoneIncomingIcon, [
    'call',
    'incoming',
    'receive',
  ]),
  IconEntry('phone-missed', kPhoneMissedIcon, ['call', 'missed', 'telephone']),
  IconEntry('phone-off', kPhoneOffIcon, ['call', 'hangup', 'mute']),
  IconEntry('pickaxe', kPickaxeIcon, ['mine', 'dig', 'tool']),
  IconEntry('play', kPlayIcon, ['media', 'player', 'start']),
  IconEntry('plug-zap', kPlugZapIcon, ['charge', 'power', 'electricity']),
];
