...
const DynamicIconData kChartColumnIncreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart('M8 17v-3', CompositePart([DrawPart(), _drawFade])),
    IconPart(
      'M13 17V9',
      CompositePart([
...
const DynamicIconData kChartLineIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart('m7 13 3-3 4 4 5-5', CompositePart([DrawPart(), _drawFade])),
  ],
);

/// Axis-less descending bars that redraw, cascading left to right.
const DynamicIconData kChartNoAxesColumnDecreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M6 20V4', CompositePart([DrawPart(), _drawFade])),
    IconPart(
      'M12 20V10',
      CompositePart([
        DrawPart(delay: Duration(milliseconds: 100)),
...
const DynamicIconData kChartNoAxesColumnIncreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M6 20v-4', CompositePart([DrawPart(), _drawFade])),
    IconPart(
      'M12 20v-10',
      CompositePart([
        DrawPart(delay: Duration(milliseconds: 100)),
...
const DynamicIconData kChartPieIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const DynamicIconData kChartScatterIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart(
      'M18 5.5a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0',
      OpacityPart(
        [0, 1],
    ...
    IconPart(
      'M11 11.5a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0',
      OpacityPart(
        [0, 1],
    ...
    IconPart(
      'M7 16.5a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0',
      OpacityPart(
        [0, 1],
    ...
    IconPart(
      'M17 14.5a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0',
      OpacityPart(
        [0, 1],
...
const DynamicIconData kChartSplineIcon = DynamicIconData(
  duration: Duration(milliseconds: 450),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart(
...
const DynamicIconData kChessBishopIcon = DynamicIconData(
...
const DynamicIconData kChessKingIcon = DynamicIconData(
...
const DynamicIconData kChessKnightIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kChessPawnIcon = DynamicIconData(
...
const DynamicIconData kChevronFirstIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'm17 18-6-6 6-6',
...
const DynamicIconData kChevronLeftIcon = DynamicIconData(
...
const DynamicIconData kChevronRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm9 18 6-6-6-6',
...
const DynamicIconData kChevronUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm18 15-6-6-6 6',
...
const DynamicIconData kChevronsDownUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm7 20 5-5 5 5',
...
const DynamicIconData kChevronsLeftRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm9 7-5 5 5 5',
...
const DynamicIconData kChevronsRightLeftIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm20 17-5-5 5-5',
...
const DynamicIconData kChevronsUpDownIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'm7 15 5 5 5-5',
...
const DynamicIconData kChromeIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const List<IconEntry> gen05Icons = [
  IconEntry('chart-column-increasing', kChartColumnIncreasingIcon, [
    'chart',
    'column',
    'bar',
    'increasing',
  ...
  IconEntry('chart-line', kChartLineIcon, [
    'chart',
    'line',
    'graph',
    'trend',
  ...
  IconEntry('chart-pie', kChartPieIcon, [
    'chart',
    'pie',
    'graph',
    'analytics',
  ...
  IconEntry('chart-scatter', kChartScatterIcon, [
    'chart',
    'scatter',
    'plot',
    'dots',
  ...
  IconEntry('chart-spline', kChartSplineIcon, [
    'chart',
    'spline',
    'curve',
    'line',
  ...
  IconEntry('chess-bishop', kChessBishopIcon, [
    'chess',
    'bishop',
    'piece',
    'game',
  ]),
  IconEntry('chess-king', kChessKingIcon, ['chess', 'king', 'piece', 'game']),
  IconEntry('chess-knight', kChessKnightIcon, [
    'chess',
    'knight',
    'horse',
    'piece',
  ...
  IconEntry('chess-pawn', kChessPawnIcon, ['chess', 'pawn', 'piece', 'game']),
  IconEntry('chevron-first', kChevronFirstIcon, [
    'chevron',
    'first',
    'skip',
    'previous',
  ...
  IconEntry('chevron-left', kChevronLeftIcon, [
    'chevron',
    'left',
    'arrow',
    'back',
  ]),
  IconEntry('chevron-right', kChevronRightIcon, [
    'chevron',
    'right',
    'arrow',
    'forward',
  ]),
  IconEntry('chevron-up', kChevronUpIcon, ['chevron', 'up', 'arrow']),
  IconEntry('chevrons-down-up', kChevronsDownUpIcon, [
    'chevrons',
    'down',
    'up',
    'collapse',
  ...
  IconEntry('chevrons-left-right', kChevronsLeftRightIcon, [
    'chevrons',
    'left',
    'right',
    'expand',
  ...
  IconEntry('chevrons-right-left', kChevronsRightLeftIcon, [
    'chevrons',
    'right',
    'left',
    'collapse',
  ...
  IconEntry('chevrons-up-down', kChevronsUpDownIcon, [
    'chevrons',
    'up',
    'down',
    'expand',
  ...
  IconEntry('chrome', kChromeIcon, ['chrome', 'browser', 'google', 'logo']),
];
