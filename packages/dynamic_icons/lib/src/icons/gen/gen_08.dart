...
const DynamicIconData kDiscordIcon = DynamicIconData(
...
const DynamicIconData kDollarSignIcon = DynamicIconData(
...
const DynamicIconData kDownvoteIcon = DynamicIconData(
...
const DynamicIconData kDribbbleIcon = DynamicIconData(
...
const DynamicIconData kDropletIcon = DynamicIconData(
...
const DynamicIconData kDrumIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  repeats: true,
  parts: [
    ...
    IconPart('m2 2 8 8', RotatePart([-10, 10, 0], curve: Curves.easeInOut)),
    IconPart(
      'm22 2-8 8',
      RotatePart(
        [10, -10, 0],
...
const DynamicIconData kEarthIcon = DynamicIconData(
...
const DynamicIconData kEuroIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const DynamicIconData kEvChargerIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart('M2 21h13'),
    IconPart('M3 7h11'),
    IconPart('m9 11-2 3h3l-2 3', OpacityPart([1, 0.4, 1])),
  ],
);

/// Expand — the four corner arrows spring outward to the corners.
const DynamicIconData kExpandIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kEyeOffIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kFacebookIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kFanIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kFeatherIcon = DynamicIconData(
...
const DynamicIconData kFigmaIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kFileChartLineIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
...
const DynamicIconData kFileCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart('M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z'),
    IconPart('M14 2v4a2 2 0 0 0 2 2h4'),
    IconPart('m9 15 2 2 4-4', CompositePart([DrawPart(), _fadeIn])),
  ],
);

/// File (corner-cut) with a checkmark that draws itself on.
const DynamicIconData kFileCheck2Icon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart('M14 2v4a2 2 0 0 0 2 2h4'),
    IconPart('M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4'),
    IconPart('m3 15 2 2 4-4', CompositePart([DrawPart(), _fadeIn])),
  ],
);

/// File whose settings gear springs a half-turn.
const DynamicIconData kFileCogIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart('M14 2v4a2 2 0 0 0 2 2h4'),
    IconPart(
...
const DynamicIconData kFilePenLineIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const List<IconEntry> gen08Icons = [
  IconEntry('discord', kDiscordIcon, ['chat', 'gaming', 'social', 'logo']),
  IconEntry('dollar-sign', kDollarSignIcon, [
    'money',
    'currency',
    'usd',
    'cash',
  ]),
  IconEntry('downvote', kDownvoteIcon, ['arrow', 'dislike', 'vote', 'down']),
  IconEntry('dribbble', kDribbbleIcon, ['basketball', 'social', 'design']),
  IconEntry('droplet', kDropletIcon, ['water', 'drop', 'liquid', 'rain']),
  IconEntry('drum', kDrumIcon, ['music', 'instrument', 'percussion']),
  IconEntry('earth', kEarthIcon, ['globe', 'world', 'planet', 'map']),
  IconEntry('euro', kEuroIcon, ['money', 'currency', 'eur', 'cash']),
  IconEntry('ev-charger', kEvChargerIcon, [
    'electric',
    'vehicle',
    'charge',
    'car',
  ]),
  IconEntry('expand', kExpandIcon, ['fullscreen', 'arrows', 'resize']),
  IconEntry('eye-off', kEyeOffIcon, ['hide', 'visibility', 'private']),
  IconEntry('facebook', kFacebookIcon, ['social', 'logo', 'meta']),
  IconEntry('fan', kFanIcon, ['cooling', 'air', 'ventilation', 'spin']),
  IconEntry('feather', kFeatherIcon, ['light', 'write', 'quill', 'bird']),
  IconEntry('figma', kFigmaIcon, ['design', 'logo', 'tool']),
  IconEntry('file-chart-line', kFileChartLineIcon, [
    'document',
    'graph',
    'report',
  ]),
  IconEntry('file-check', kFileCheckIcon, ['document', 'done', 'verified']),
  IconEntry('file-check-2', kFileCheck2Icon, ['document', 'done', 'verified']),
  IconEntry('file-cog', kFileCogIcon, ['document', 'settings', 'gear']),
  IconEntry('file-pen-line', kFilePenLineIcon, [
    'document',
    'edit',
    'write',
    'sign',
