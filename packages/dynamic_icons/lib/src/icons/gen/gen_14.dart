...
const DynamicIconData kMapPinOffIcon = DynamicIconData(
...
const DynamicIconData kMapPinPlusIcon = DynamicIconData(
...
const DynamicIconData kMapPinPlusInsideIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  parts: [
    IconPart(
...
const DynamicIconData kMapPinXInsideIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  parts: [
    IconPart(
      'M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0',
...
const DynamicIconData kMaximizeIcon = DynamicIconData(
...
const DynamicIconData kMaximize2Icon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kMehIcon = DynamicIconData(
...
const DynamicIconData kMessageCircleIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kMessageCircleCheckIcon = DynamicIconData(
...
const DynamicIconData kMessageCircleDashedIcon = DynamicIconData(
...
const DynamicIconData kMessageCircleMoreIcon = DynamicIconData(
...
const DynamicIconData kMessageCirclePlusIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719',
...
const DynamicIconData kMessageCircleXIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719',
...
const DynamicIconData kMessageSquareIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kMessageSquareCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.7.7 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z',
    ),
    IconPart('m9 11 2 2 4-4', CompositePart([DrawPart(), _fadeIn])),
  ],
);

/// Square message bubble drawn from dashes that fade in one by one.
const DynamicIconData kMessageSquareDashedIcon = DynamicIconData(
...
const DynamicIconData kMessageSquareMoreIcon = DynamicIconData(
  duration: Duration(milliseconds: 1500),
  repeats: true,
  parts: [
...
const DynamicIconData kMessageSquarePlusIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kMessageSquareXIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z',
...
const DynamicIconData kMicIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M12 19v3'),
...
const List<IconEntry> gen14Icons = [
  IconEntry('map-pin-off', kMapPinOffIcon, ['map', 'pin', 'off', 'location']),
  IconEntry('map-pin-plus', kMapPinPlusIcon, [
    'map',
    'pin',
    'plus',
    'add',
  ...
  IconEntry('map-pin-plus-inside', kMapPinPlusInsideIcon, [
    'map',
    'pin',
    'plus',
    'add',
  ...
  IconEntry('map-pin-x-inside', kMapPinXInsideIcon, [
    'map',
    'pin',
    'x',
    'remove',
  ...
  IconEntry('maximize', kMaximizeIcon, [
    'maximize',
    'expand',
    'fullscreen',
    'corners',
  ]),
  IconEntry('maximize-2', kMaximize2Icon, [
    'maximize',
    'expand',
    'fullscreen',
    'arrows',
  ]),
  IconEntry('meh', kMehIcon, ['meh', 'face', 'emoji', 'neutral', 'emotion']),
  IconEntry('message-circle', kMessageCircleIcon, [
    'message',
    'chat',
    'circle',
    'bubble',
  ...
  IconEntry('message-circle-check', kMessageCircleCheckIcon, [
    'message',
    'chat',
    'check',
    'done',
  ...
  IconEntry('message-circle-dashed', kMessageCircleDashedIcon, [
    'message',
    'chat',
    'dashed',
    'bubble',
  ...
  IconEntry('message-circle-more', kMessageCircleMoreIcon, [
    'message',
    'chat',
    'more',
    'dots',
  ...
  IconEntry('message-circle-plus', kMessageCirclePlusIcon, [
    'message',
    'chat',
    'plus',
    'add',
  ...
  IconEntry('message-circle-x', kMessageCircleXIcon, [
    'message',
    'chat',
    'x',
    'close',
  ...
  IconEntry('message-square', kMessageSquareIcon, [
    'message',
    'chat',
    'square',
    'bubble',
  ...
  IconEntry('message-square-check', kMessageSquareCheckIcon, [
    'message',
    'chat',
    'check',
    'done',
  ...
  IconEntry('message-square-dashed', kMessageSquareDashedIcon, [
    'message',
    'chat',
    'dashed',
    'square',
  ...
  IconEntry('message-square-more', kMessageSquareMoreIcon, [
    'message',
    'chat',
    'more',
    'dots',
  ...
  IconEntry('message-square-plus', kMessageSquarePlusIcon, [
    'message',
    'chat',
    'plus',
    'add',
  ...
  IconEntry('message-square-x', kMessageSquareXIcon, [
    'message',
    'chat',
    'x',
    'close',
  ...
  IconEntry('mic', kMicIcon, ['mic', 'microphone', 'audio', 'record', 'voice']),
];
