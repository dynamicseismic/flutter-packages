...
const DynamicIconData kArrowBigDownIcon = DynamicIconData(
...
const DynamicIconData kArrowBigDownDashIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'M15 5H9',
...
const DynamicIconData kArrowBigLeftIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
...
const DynamicIconData kArrowBigLeftDashIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'M19 15V9',
...
const DynamicIconData kArrowBigRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
...
const DynamicIconData kArrowBigRightDashIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart('M5 9v6', TranslatePart([Offset.zero, Offset(1, 0), Offset.zero])),
    IconPart(
...
const DynamicIconData kArrowBigUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
...
const DynamicIconData kArrowBigUpDashIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'M9 19h6',
...
const DynamicIconData kArrowDown01Icon = DynamicIconData(
...
const DynamicIconData kArrowDown10Icon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('m3 16 4 4 4-4'),
    IconPart('M7 20V4'),
...
const DynamicIconData kArrowDownAZIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('m3 16 4 4 4-4'),
    IconPart('M7 20V4'),
...
const DynamicIconData kArrowDownZAIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('m3 16 4 4 4-4'),
    IconPart('M7 20V4'),
...
const DynamicIconData kArrowDownLeftIcon = DynamicIconData(
...
const DynamicIconData kArrowDownRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'M7 7 L17 17',
...
const DynamicIconData kArrowLeftIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'm12 19-7-7 7-7',
...
const DynamicIconData kArrowUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
      'm5 12 7-7 7 7',
...
const DynamicIconData kArrowUpLeftIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
...
const DynamicIconData kArrowUpRightIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
...
const DynamicIconData kAtSignIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kAtomIcon = DynamicIconData(
...
const List<IconEntry> gen02Icons = [
  IconEntry('arrow-big-down', kArrowBigDownIcon, ['arrow', 'down', 'big']),
  IconEntry('arrow-big-down-dash', kArrowBigDownDashIcon, [
    'arrow',
    'down',
    'big',
    'dash',
  ]),
  IconEntry('arrow-big-left', kArrowBigLeftIcon, ['arrow', 'left', 'big']),
  IconEntry('arrow-big-left-dash', kArrowBigLeftDashIcon, [
    'arrow',
    'left',
    'big',
    'dash',
  ]),
  IconEntry('arrow-big-right', kArrowBigRightIcon, ['arrow', 'right', 'big']),
  IconEntry('arrow-big-right-dash', kArrowBigRightDashIcon, [
    'arrow',
    'right',
    'big',
    'dash',
  ]),
  IconEntry('arrow-big-up', kArrowBigUpIcon, ['arrow', 'up', 'big']),
  IconEntry('arrow-big-up-dash', kArrowBigUpDashIcon, [
    'arrow',
    'up',
    'big',
    'dash',
  ]),
  IconEntry('arrow-down-0-1', kArrowDown01Icon, [
    'arrow',
    'down',
    'sort',
    'ascending',
  ...
  IconEntry('arrow-down-1-0', kArrowDown10Icon, [
    'arrow',
    'down',
    'sort',
    'descending',
  ...
  IconEntry('arrow-down-a-z', kArrowDownAZIcon, [
    'arrow',
    'down',
    'sort',
    'ascending',
  ...
  IconEntry('arrow-down-left', kArrowDownLeftIcon, [
    'arrow',
    'down',
    'left',
    'diagonal',
  ]),
  IconEntry('arrow-down-right', kArrowDownRightIcon, [
    'arrow',
    'down',
    'right',
    'diagonal',
  ]),
  IconEntry('arrow-down-z-a', kArrowDownZAIcon, [
    'arrow',
    'down',
    'sort',
    'descending',
  ...
  IconEntry('arrow-left', kArrowLeftIcon, ['arrow', 'left', 'back']),
  IconEntry('arrow-up', kArrowUpIcon, ['arrow', 'up']),
  IconEntry('arrow-up-left', kArrowUpLeftIcon, [
    'arrow',
    'up',
    'left',
    'diagonal',
  ]),
  IconEntry('arrow-up-right', kArrowUpRightIcon, [
    'arrow',
    'up',
    'right',
    'diagonal',
  ]),
  IconEntry('at-sign', kAtSignIcon, ['at', 'email', 'mention', 'sign']),
  IconEntry('atom', kAtomIcon, ['atom', 'science', 'physics', 'nucleus']),
];
