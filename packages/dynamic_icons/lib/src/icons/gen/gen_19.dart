...
const DynamicIconData kTelescopeIcon = DynamicIconData(
...
const DynamicIconData kTerminalIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  repeats: true,
  parts: [
...
const DynamicIconData kThermometerIcon = DynamicIconData(
...
const DynamicIconData kTimerIcon = DynamicIconData(
...
const DynamicIconData kTornadoIcon = DynamicIconData(
...
const DynamicIconData kTrainTrackIcon = DynamicIconData(
  duration: Duration(milliseconds: 800),
  parts: [
    IconPart('M2 17 17 2'),
    IconPart('M7 22 22 7'),
...
const DynamicIconData kTrendingDownIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kTrendingUpDownIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kTruckIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  repeats: true,
  parts: [
    IconPart(
    ...
    IconPart(
      ...
      CompositePart([
        TranslatePart(
          [Offset.zero, Offset(-4, 0), Offset(-10, 0), Offset(-16, 0)],
...
const DynamicIconData kTurkishLiraIcon = DynamicIconData(
...
const DynamicIconData kTwitchIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kTwitterIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kUnderlineIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kUndoIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kUndoDotIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kUpvoteIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kUserIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kUserCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart('M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2'),
    IconPart('M5 7a4 4 0 1 0 8 0 4 4 0 1 0 -8 0'),
    IconPart('M16 11L18 13L22 9', CompositePart([DrawPart(), _fadeIn])),
  ],
);

/// User-round-check: the figure stays put while the check draws itself on.
const DynamicIconData kUserRoundCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 400),
  parts: [
...
const DynamicIconData kUserRoundCogIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
...
const List<IconEntry> gen19Icons = [
  IconEntry('telescope', kTelescopeIcon, [
    'astronomy',
    'space',
    'stars',
    'observe',
  ]),
  IconEntry('terminal', kTerminalIcon, ['console', 'command', 'shell', 'code']),
  IconEntry('thermometer', kThermometerIcon, [
    'temperature',
    'heat',
    'weather',
    'fever',
  ]),
  IconEntry('timer', kTimerIcon, ['stopwatch', 'clock', 'countdown', 'time']),
  IconEntry('tornado', kTornadoIcon, ['storm', 'weather', 'wind', 'twister']),
  IconEntry('train-track', kTrainTrackIcon, [
    'railway',
    'rail',
    'transport',
    'track',
  ]),
  IconEntry('trending-down', kTrendingDownIcon, [
    'chart',
    'decrease',
    'analytics',
    'down',
  ]),
  IconEntry('trending-up-down', kTrendingUpDownIcon, [
    'chart',
    'volatile',
    'analytics',
    'fluctuate',
  ]),
  IconEntry('truck', kTruckIcon, [
    'delivery',
    'shipping',
    'transport',
    'vehicle',
  ]),
  IconEntry('turkish-lira', kTurkishLiraIcon, [
    'currency',
    'money',
    'finance',
    'try',
  ]),
  IconEntry('twitch', kTwitchIcon, ['stream', 'gaming', 'social', 'brand']),
  IconEntry('twitter', kTwitterIcon, ['social', 'bird', 'tweet', 'brand']),
  IconEntry('underline', kUnderlineIcon, ['text', 'format', 'style', 'editor']),
  IconEntry('undo', kUndoIcon, ['back', 'revert', 'history', 'arrow']),
  IconEntry('undo-dot', kUndoDotIcon, ['back', 'revert', 'history', 'arrow']),
  IconEntry('upvote', kUpvoteIcon, ['like', 'thumbs up', 'vote', 'arrow']),
  IconEntry('user', kUserIcon, ['person', 'profile', 'account', 'avatar']),
  IconEntry('user-check', kUserCheckIcon, [
    'person',
    'verified',
    'approved',
    'account',
  ]),
  IconEntry('user-round-check', kUserRoundCheckIcon, [
    'person',
    'verified',
    'approved',
    'account',
  ]),
  IconEntry('user-round-cog', kUserRoundCogIcon, [
    'person',
    'settings',
    'account',
    'gear',
