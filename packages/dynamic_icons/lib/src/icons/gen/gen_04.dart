...
const DynamicIconData kBookTextIcon = DynamicIconData(
...
const DynamicIconData kBookmarkCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kBookmarkMinusIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
    ...
    IconPart('M15 10L9 10', DrawPart(duration: Duration(milliseconds: 300))),
  ],
);

/// Bookmark squashes while the plus strokes draw on, one after the other.
const DynamicIconData kBookmarkPlusIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart('M12 7L12 13', DrawPart(duration: Duration(milliseconds: 300))),
    IconPart(
      'M15 10L9 10',
      DrawPart(
...
const DynamicIconData kBookmarkXIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart(
      'm19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z',
    ...
    IconPart('m14.5 7.5-5 5', DrawPart(duration: Duration(milliseconds: 300))),
    IconPart(
      'm9.5 7.5 5 5',
      DrawPart(
        delay: Duration(milliseconds: 100),
...
const DynamicIconData kBotIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart('M12 8V4H8'),
    IconPart(
...
const DynamicIconData kBotMessageSquareIcon = DynamicIconData(
...
const DynamicIconData kBoxIcon = DynamicIconData(
...
const DynamicIconData kBoxesIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const DynamicIconData kBrainIcon = DynamicIconData(
...
const DynamicIconData kBriefcaseBusinessIcon = DynamicIconData(
...
const DynamicIconData kCalendarCheckIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M8 2v4'),
    IconPart('M16 2v4'),
...
const DynamicIconData kCalendarCheck2Icon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M8 2v4'),
    IconPart('M16 2v4'),
...
const DynamicIconData kCalendarCogIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
...
const DynamicIconData kCalendarDaysIcon = DynamicIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart('M8 2v4'),
    IconPart('M16 2v4'),
...
const DynamicIconData kCartIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kCctvIcon = DynamicIconData(
  ...
  parts: [
    ...
    IconPart('M7 9h.01', OpacityPart([1, 0, 1, 0, 1, 0, 1])),
...
const DynamicIconData kChartBarDecreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart('M7 6h12', DrawPart(duration: Duration(milliseconds: 300))),
    IconPart(
      'M7 11h8',
      DrawPart(
        delay: Duration(milliseconds: 100),
...
const DynamicIconData kChartBarIncreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart('M7 6h3', DrawPart(duration: Duration(milliseconds: 300))),
    IconPart(
      'M7 11h8',
      DrawPart(
        delay: Duration(milliseconds: 100),
...
const DynamicIconData kChartColumnDecreasingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M3 3v16a2 2 0 0 0 2 2h16'),
    IconPart(
...
const List<IconEntry> gen04Icons = [
  IconEntry('book-text', kBookTextIcon, ['book', 'text', 'read', 'document']),
  IconEntry('bookmark-check', kBookmarkCheckIcon, [
    'bookmark',
    'check',
    'saved',
    'confirm',
  ]),
  IconEntry('bookmark-minus', kBookmarkMinusIcon, [
    'bookmark',
    'minus',
    'remove',
    'subtract',
  ]),
  IconEntry('bookmark-plus', kBookmarkPlusIcon, [
    'bookmark',
    'plus',
    'add',
    'save',
  ]),
  IconEntry('bookmark-x', kBookmarkXIcon, [
    'bookmark',
    'x',
    'remove',
    'delete',
  ]),
  IconEntry('bot', kBotIcon, ['bot', 'robot', 'ai', 'chatbot']),
  IconEntry('bot-message-square', kBotMessageSquareIcon, [
    'bot',
    'message',
    'chat',
    'ai',
  ...
  IconEntry('box', kBoxIcon, ['box', 'package', 'cube', 'parcel']),
  IconEntry('boxes', kBoxesIcon, ['boxes', 'packages', 'stack', 'storage']),
  IconEntry('brain', kBrainIcon, ['brain', 'mind', 'think', 'ai']),
  IconEntry('briefcase-business', kBriefcaseBusinessIcon, [
    'briefcase',
    'business',
    'work',
    'job',
  ]),
  IconEntry('calendar-check', kCalendarCheckIcon, [
    'calendar',
    'check',
    'date',
    'event',
  ...
  IconEntry('calendar-check-2', kCalendarCheck2Icon, [
    'calendar',
    'check',
    'date',
    'event',
  ...
  IconEntry('calendar-cog', kCalendarCogIcon, [
    'calendar',
    'cog',
    'settings',
    'schedule',
  ]),
  IconEntry('calendar-days', kCalendarDaysIcon, [
    'calendar',
    'days',
    'date',
    'month',
  ...
  IconEntry('cart', kCartIcon, ['cart', 'shopping', 'buy', 'ecommerce']),
  IconEntry('cctv', kCctvIcon, ['cctv', 'camera', 'security', 'surveillance']),
  IconEntry('chart-bar-decreasing', kChartBarDecreasingIcon, [
    'chart',
    'bar',
    'decreasing',
    'graph',
  ...
  IconEntry('chart-bar-increasing', kChartBarIncreasingIcon, [
    'chart',
    'bar',
    'increasing',
    'graph',
  ...
  IconEntry('chart-column-decreasing', kChartColumnDecreasingIcon, [
    'chart',
    'column',
    'decreasing',
    'graph',
