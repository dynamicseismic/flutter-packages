...
const DynamicIconData kBellIcon = DynamicIconData(
...
const DynamicIconData kCogIcon = DynamicIconData(
...
const DynamicIconData kRefreshCwIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
      [
...
const DynamicIconData kRotateCwIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
...
const DynamicIconData kPlusIcon = DynamicIconData(
...
const DynamicIconData kLoaderCircleIcon = DynamicIconData(
...
const DynamicIconData kCompassIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
...
const DynamicIconData kMoonIcon = DynamicIconData(
