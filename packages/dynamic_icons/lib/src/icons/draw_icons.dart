...
const DynamicIconData kActivityIcon = DynamicIconData(
...
const DynamicIconData kZapIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kCheckIcon = DynamicIconData(
...
const DynamicIconData kCheckCheckIcon = DynamicIconData(
...
const DynamicIconData kHeartPulseIcon = DynamicIconData(
...
const DynamicIconData kTrendingUpIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kSquarePenIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
...
const DynamicIconData kXIcon = DynamicIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M18 6 6 18', CompositePart([DrawPart(), _fadeIn])),
    IconPart(
      'm6 6 12 12',
      CompositePart([
