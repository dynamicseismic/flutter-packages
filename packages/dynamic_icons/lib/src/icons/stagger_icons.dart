...
const DynamicIconData kVolumeIcon = DynamicIconData(
...
const DynamicIconData kAudioLinesIcon = DynamicIconData(
...
const DynamicIconData kRadioIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const DynamicIconData kBluetoothSearchingIcon = DynamicIconData(
  duration: Duration(milliseconds: 600),
  repeats: true,
  parts: [
...
const DynamicIconData kCastIcon = DynamicIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart('M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6'),
    IconPart(
      'M2 20 2.01 20',
      OpacityPart([0, 1], duration: Duration(milliseconds: 500)),
    ),
    IconPart(
      'M2 16a5 5 0 0 1 4 4',
      OpacityPart(
...
const DynamicIconData kSunIcon = DynamicIconData(
