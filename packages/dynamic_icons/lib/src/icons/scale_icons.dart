...
const DynamicIconData kHeartIcon = DynamicIconData(
...
const DynamicIconData kSparklesIcon = DynamicIconData(
...
const DynamicIconData kSearchIcon = DynamicIconData(
  duration: Duration(milliseconds: 1000),
  parts: [
    IconPart.group([
...
const DynamicIconData kBookmarkIcon = DynamicIconData(
...
const DynamicIconData kEyeIcon = DynamicIconData(
...
const DynamicIconData kBatteryChargingIcon = DynamicIconData(
