...
const LucideIconData kUserRoundPlusIcon = LucideIconData(
...
const LucideIconData kUsersIcon = LucideIconData(
  ...
  parts: [
    ...
    IconPart.group(
      ...
      TranslatePart([Offset(-6, 0), Offset.zero],
...
const LucideIconData kUsersRoundIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
...
const LucideIconData kVibrateIcon = LucideIconData(
...
const LucideIconData kWalletIcon = LucideIconData(
...
const LucideIconData kWashingMachineIcon = LucideIconData(
...
const LucideIconData kWavesIcon = LucideIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
...
const LucideIconData kWavesLadderIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  parts: [
    IconPart(
...
const LucideIconData kWaypointsIcon = LucideIconData(
...
const LucideIconData kWebhookIcon = LucideIconData(
...
const LucideIconData kWifiCogIcon = LucideIconData(
  duration: Duration(milliseconds: 700),
  parts: [
...
const LucideIconData kWifiLowIcon = LucideIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart('M12 20h.01'),
    IconPart(
...
const LucideIconData kWifiPenIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
...
const LucideIconData kWifiSyncIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M2 8.82a15 15 0 0 1 20 0'),
...
const LucideIconData kWindIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kWindArrowDownIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kWorkflowIcon = LucideIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart(
...
const LucideIconData kWrenchIcon = LucideIconData(
...
const LucideIconData kYoutubeIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const LucideIconData kZapOffIcon = LucideIconData(
...
const List<LucideIconEntry> gen20Icons = [
  LucideIconEntry('user-round-plus', kUserRoundPlusIcon,
      ['user', 'person', 'add', 'plus', 'invite']),
  LucideIconEntry('users', kUsersIcon, ['people', 'group', 'team', 'contacts']),
  LucideIconEntry(
  ...
  LucideIconEntry('washing-machine', kWashingMachineIcon,
      ['laundry', 'wash', 'appliance', 'clothes']),
  LucideIconEntry('waves', kWavesIcon, ['water', 'sea', 'ocean', 'ripple']),
  LucideIconEntry('waves-ladder', kWavesLadderIcon,
      ['pool', 'swim', 'water', 'ladder']),
  LucideIconEntry('waypoints', kWaypointsIcon,
  ...
  LucideIconEntry('wifi-pen', kWifiPenIcon, ['wifi', 'network', 'edit', 'pen']),
  LucideIconEntry(
      'wifi-sync', kWifiSyncIcon, ['wifi', 'network', 'sync', 'refresh']),
  LucideIconEntry('wind', kWindIcon, ['weather', 'air', 'breeze', 'gust']),
  LucideIconEntry('wind-arrow-down', kWindArrowDownIcon,
      ['weather', 'wind', 'arrow', 'down']),
  LucideIconEntry(
      'workflow', kWorkflowIcon, ['flow', 'process', 'diagram', 'nodes']),
  LucideIconEntry('wrench', kWrenchIcon, ['tool', 'fix', 'repair', 'settings']),
  LucideIconEntry(
