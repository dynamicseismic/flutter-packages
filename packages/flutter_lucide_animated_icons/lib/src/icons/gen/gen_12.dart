...
const LucideIconData kHandHeartIcon = LucideIconData(
...
const LucideIconData kHandHelpingIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kHandMetalIcon = LucideIconData(
...
const LucideIconData kHardDriveDownloadIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
    ...
    IconPart.group(
      ...
      TranslatePart([Offset(0, -1), Offset.zero],
...
const LucideIconData kHardDriveUploadIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
        'M4 14h18a2 2 0 0 1 2 2v4a2 2 0 0 1 -2 2h-18a2 2 0 0 1 -2 -2v-4a2 2 0 0 1 2 -2z'),
...
const LucideIconData kHeartHandshakeIcon = LucideIconData(
...
const LucideIconData kHistoryIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart.group(
      [
    ...
    IconPart(
      'M12 12 16 14',
      RotatePart([0, -45], pivot: Offset(12, 12)),
    ),
  ],
);

/// Home: the door draws itself in beneath the static roof.
const LucideIconData kHomeIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const LucideIconData kHourglassIcon = LucideIconData(
  duration: Duration(milliseconds: 700),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kIdCardIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
...
const LucideIconData kIndianRupeeIcon = LucideIconData(
...
const LucideIconData kInstagramIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
...
const LucideIconData kItalicIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart(
      'M19 4 L10 4',
...
const LucideIconData kJapaneseYenIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kKeyIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kKeyCircleIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kKeySquareIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kKeyboardIcon = LucideIconData(
...
const LucideIconData kLanguagesIcon = LucideIconData(
...
const LucideIconData kLaptopMinimalCheckIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M2 20h20'),
    IconPart(
...
const List<LucideIconEntry> gen12Icons = [
  LucideIconEntry('hand-heart', kHandHeartIcon, ['hand', 'heart', 'give', 'love']),
  LucideIconEntry('hand-helping', kHandHelpingIcon, ['hand', 'help', 'support', 'assist']),
  LucideIconEntry('hand-metal', kHandMetalIcon, ['hand', 'metal', 'rock', 'horns']),
  LucideIconEntry('hard-drive-download', kHardDriveDownloadIcon, ['hard', 'drive', 'download', 'storage']),
  LucideIconEntry('hard-drive-upload', kHardDriveUploadIcon, ['hard', 'drive', 'upload', 'storage']),
  LucideIconEntry('heart-handshake', kHeartHandshakeIcon, ['heart', 'handshake', 'deal', 'love', 'agreement']),
  LucideIconEntry('history', kHistoryIcon, ['history', 'clock', 'undo', 'time', 'revert']),
  LucideIconEntry('home', kHomeIcon, ['home', 'house', 'main', 'start']),
  LucideIconEntry('hourglass', kHourglassIcon, ['hourglass', 'time', 'wait', 'loading']),
  LucideIconEntry('id-card', kIdCardIcon, ['id', 'card', 'identity', 'badge', 'profile']),
  LucideIconEntry('indian-rupee', kIndianRupeeIcon, ['indian', 'rupee', 'currency', 'money', 'inr']),
  LucideIconEntry('instagram', kInstagramIcon, ['instagram', 'social', 'photo', 'logo']),
  LucideIconEntry('italic', kItalicIcon, ['italic', 'text', 'format', 'style']),
  LucideIconEntry('japanese-yen', kJapaneseYenIcon, ['japanese', 'yen', 'currency', 'money', 'jpy']),
  LucideIconEntry('key', kKeyIcon, ['key', 'unlock', 'password', 'access']),
  LucideIconEntry('key-circle', kKeyCircleIcon, ['key', 'circle', 'unlock', 'access']),
  LucideIconEntry('key-square', kKeySquareIcon, ['key', 'square', 'unlock', 'access']),
  LucideIconEntry('keyboard', kKeyboardIcon, ['keyboard', 'type', 'input', 'keys']),
  LucideIconEntry('languages', kLanguagesIcon, ['languages', 'translate', 'locale', 'i18n']),
  LucideIconEntry('laptop-minimal-check', kLaptopMinimalCheckIcon, ['laptop', 'check', 'verified', 'computer']),
];
