...
`dynamic_keyboard_layout` uses Rust internally to implement low-level platform specific functionality.
...
Example project is available at `dynamic_keyboard_layout/example`.
...
After this you can open the folder in VSCode and run the `dynamic_keyboard_layout` launcher configuration.
