...
const LucideIconData kPoundSterlingIcon = LucideIconData(
...
const LucideIconData kProjectorIcon = LucideIconData(
...
const LucideIconData kRabbitIcon = LucideIconData(
...
const LucideIconData kRadioTowerIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M4.9 16.1C1 12.2 1 5.8 4.9 1.9',
        OpacityPart([0, 1], delay: Duration(milliseconds: 100), curve: _rayEase)),
    IconPart('M7.8 4.7a6.14 6.14 0 0 0-.8 7.5',
        OpacityPart([0, 1], curve: _rayEase)),
    IconPart('M10 9a2 2 0 1 0 4 0 2 2 0 1 0 -4 0'),
    IconPart('M16.2 4.8c2 2 2.26 5.11.8 7.47',
        OpacityPart([0, 1], curve: _rayEase)),
    IconPart('M19.1 1.9a9.96 9.96 0 0 1 0 14.1',
        OpacityPart([0, 1], delay: Duration(milliseconds: 100), curve: _rayEase)),
    IconPart('M9.5 18h5'),
...
const LucideIconData kReceiptIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'M12 17V7',
...
const LucideIconData kReceiptCentIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'M12 7v10',
...
const LucideIconData kReceiptEuroIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kReceiptIndianRupeeIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
        'M4 3a1 1 0 0 1 1-1 1.3 1.3 0 0 1 .7.2l.933.6a1.3 1.3 0 0 0 1.4 0l.934-.6a1.3 1.3 0 0 1 1.4 0l.933.6a1.3 1.3 0 0 0 1.4 0l.933-.6a1.3 1.3 0 0 1 1.4 0l.934.6a1.3 1.3 0 0 0 1.4 0l.933-.6A1.3 1.3 0 0 1 19 2a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1 1.3 1.3 0 0 1-.7-.2l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.934.6a1.3 1.3 0 0 1-1.4 0l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-1.4 0l-.934-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-.7.2 1 1 0 0 1-1-1z'),
...
const LucideIconData kReceiptJapaneseYenIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'm12 10 3-3',
...
const LucideIconData kReceiptPoundSterlingIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kReceiptRussianRubleIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
        'M4 3a1 1 0 0 1 1-1 1.3 1.3 0 0 1 .7.2l.933.6a1.3 1.3 0 0 0 1.4 0l.934-.6a1.3 1.3 0 0 1 1.4 0l.933.6a1.3 1.3 0 0 0 1.4 0l.933-.6a1.3 1.3 0 0 1 1.4 0l.934.6a1.3 1.3 0 0 0 1.4 0l.933-.6A1.3 1.3 0 0 1 19 2a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1 1.3 1.3 0 0 1-.7-.2l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.934.6a1.3 1.3 0 0 1-1.4 0l-.933-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-1.4 0l-.934-.6a1.3 1.3 0 0 0-1.4 0l-.933.6a1.3 1.3 0 0 1-.7.2 1 1 0 0 1-1-1z'),
...
const LucideIconData kReceiptSwissFrancIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
      'M10 11h4',
...
const LucideIconData kReceiptTextIcon = LucideIconData(
  ...
  parts: [
    ...
    IconPart(
      'M8 8H14',
      DrawPart(duration: Duration(milliseconds: 350)),
    ),
    IconPart(
      'M8 12H16',
      DrawPart(
...
const LucideIconData kReceiptTurkishLiraIcon = LucideIconData(
  duration: Duration(milliseconds: 900),
  parts: [
    IconPart(
...
const LucideIconData kRedoIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'M21 7v6h-6',
...
const LucideIconData kRedoDotIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart(
      'M21 7v6h-6',
...
const LucideIconData kRefreshCcwIcon = LucideIconData(
...
const LucideIconData kRefreshCcwDotIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart.group(
      [
...
const LucideIconData kRefreshCwOffIcon = LucideIconData(
...
const LucideIconData kRocketIcon = LucideIconData(
...
const List<LucideIconEntry> gen16Icons = [
  LucideIconEntry('pound-sterling', kPoundSterlingIcon,
      ['pound', 'sterling', 'currency', 'money', 'gbp']),
  LucideIconEntry(
      'projector', kProjectorIcon, ['projector', 'presentation', 'beamer']),
  LucideIconEntry('rabbit', kRabbitIcon, ['rabbit', 'bunny', 'animal', 'fast']),
  LucideIconEntry('radio-tower', kRadioTowerIcon,
      ['radio', 'tower', 'signal', 'broadcast', 'antenna']),
  LucideIconEntry('receipt', kReceiptIcon,
      ['receipt', 'bill', 'invoice', 'dollar', 'payment']),
  LucideIconEntry('receipt-cent', kReceiptCentIcon,
      ['receipt', 'cent', 'currency', 'invoice', 'bill']),
  LucideIconEntry('receipt-euro', kReceiptEuroIcon,
      ['receipt', 'euro', 'currency', 'invoice', 'bill']),
  LucideIconEntry('receipt-indian-rupee', kReceiptIndianRupeeIcon,
      ['receipt', 'rupee', 'indian', 'currency', 'invoice']),
  LucideIconEntry('receipt-japanese-yen', kReceiptJapaneseYenIcon,
      ['receipt', 'yen', 'japanese', 'currency', 'invoice']),
  LucideIconEntry('receipt-pound-sterling', kReceiptPoundSterlingIcon,
      ['receipt', 'pound', 'sterling', 'currency', 'invoice']),
  LucideIconEntry('receipt-russian-ruble', kReceiptRussianRubleIcon,
      ['receipt', 'ruble', 'russian', 'currency', 'invoice']),
  LucideIconEntry('receipt-swiss-franc', kReceiptSwissFrancIcon,
      ['receipt', 'franc', 'swiss', 'currency', 'invoice']),
  LucideIconEntry('receipt-text', kReceiptTextIcon,
      ['receipt', 'text', 'lines', 'invoice', 'bill']),
  LucideIconEntry('receipt-turkish-lira', kReceiptTurkishLiraIcon,
      ['receipt', 'lira', 'turkish', 'currency', 'invoice']),
  LucideIconEntry('redo', kRedoIcon, ['redo', 'arrow', 'forward', 'repeat']),
  LucideIconEntry(
      'redo-dot', kRedoDotIcon, ['redo', 'dot', 'arrow', 'forward', 'repeat']),
  LucideIconEntry('refresh-ccw', kRefreshCcwIcon,
      ['refresh', 'reload', 'sync', 'counterclockwise', 'rotate']),
  LucideIconEntry('refresh-ccw-dot', kRefreshCcwDotIcon,
      ['refresh', 'reload', 'sync', 'dot', 'rotate']),
  LucideIconEntry('refresh-cw-off', kRefreshCwOffIcon,
