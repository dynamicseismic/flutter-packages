...
const LucideIconData kCircleCheckIcon = LucideIconData(
...
const LucideIconData kCircleChevronDownIcon = LucideIconData(
...
const LucideIconData kCircleChevronLeftIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart(
...
const LucideIconData kCircleChevronRightIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart(
...
const LucideIconData kCircleChevronUpIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart(
...
const LucideIconData kCircleDashedIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  parts: [
    IconPart('M10.1 2.182a10 10 0 0 1 3.8 0',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 100),
            duration: Duration(milliseconds: 300))),
    IconPart('M13.9 21.818a10 10 0 0 1-3.8 0',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 200),
            duration: Duration(milliseconds: 300))),
    IconPart('M17.609 3.721a10 10 0 0 1 2.69 2.7',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 300),
            duration: Duration(milliseconds: 300))),
    IconPart('M2.182 13.9a10 10 0 0 1 0-3.8',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 400),
            duration: Duration(milliseconds: 300))),
    IconPart('M20.279 17.609a10 10 0 0 1-2.7 2.69',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 500),
            duration: Duration(milliseconds: 300))),
    IconPart('M21.818 10.1a10 10 0 0 1 0 3.8',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 600),
            duration: Duration(milliseconds: 300))),
    IconPart('M3.721 6.391a10 10 0 0 1 2.7-2.69',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 700),
            duration: Duration(milliseconds: 300))),
    IconPart('M6.391 20.279a10 10 0 0 1-2.69-2.7',
        OpacityPart([0, 1],
...
const LucideIconData kCircleDollarSignIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart(
...
const LucideIconData kCircleHelpIcon = LucideIconData(
  duration: Duration(milliseconds: 500),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart.group(
...
const LucideIconData kClapIcon = LucideIconData(
...
const LucideIconData kClipboardCheckIcon = LucideIconData(
  duration: Duration(milliseconds: 400),
  parts: [
    IconPart(
    ...
    IconPart(
      'm9 14 2 2 4-4',
      CompositePart([DrawPart(), OpacityPart([0, 1])]),
    ),
  ],
);

/// Clock whose hands sweep around (hour hand a full turn, minute hand 45°).
const LucideIconData kClockIcon = LucideIconData(
  duration: Duration(milliseconds: 600),
  parts: [
    IconPart('M2 12a10 10 0 1 0 20 0a10 10 0 1 0 -20 0'),
    IconPart(
      'M12 12 16 12',
      RotatePart([0, 45], pivot: kViewBoxCenter),
    ),
    IconPart(
      'M12 12 12 6',
      RotatePart([0, 360],
...
const LucideIconData kCloudCogIcon = LucideIconData(
...
const LucideIconData kCloudDownloadIcon = LucideIconData(
  duration: Duration(milliseconds: 300),
  parts: [
    IconPart('M4.2 15.1A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.2'),
    IconPart.group(
...
const LucideIconData kCloudLightningIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  repeats: true,
  parts: [
...
const LucideIconData kCloudRainIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  repeats: true,
  parts: [
...
const LucideIconData kCloudRainWindIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  repeats: true,
  parts: [
    IconPart('M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242'),
...
const LucideIconData kCloudSnowIcon = LucideIconData(
...
const LucideIconData kCloudSunIcon = LucideIconData(
  duration: Duration(milliseconds: 1000),
  parts: [
    IconPart('M12 2v2',
        OpacityPart([0, 1],
    ...
    IconPart('m19.07 4.93-1.41 1.41',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 400),
            duration: Duration(milliseconds: 300))),
    IconPart('M15.947 12.65a4 4 0 0 0-5.925-4.128',
        OpacityPart([0, 1],
            delay: Duration(milliseconds: 500),
            duration: Duration(milliseconds: 300))),
    IconPart(
...
const LucideIconData kCloudUploadIcon = LucideIconData(
  duration: Duration(milliseconds: 300),
  parts: [
    IconPart('M4.2 15.1A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.2'),
    IconPart.group(
...
const LucideIconData kCoffeeIcon = LucideIconData(
  duration: Duration(milliseconds: 1500),
  repeats: true,
  parts: [
    IconPart(
...
const List<LucideIconEntry> gen06Icons = [
  LucideIconEntry('circle-check', kCircleCheckIcon, ['check', 'tick', 'verified', 'circle']),
  LucideIconEntry('circle-chevron-down', kCircleChevronDownIcon, ['chevron', 'down', 'arrow', 'circle']),
  LucideIconEntry('circle-chevron-left', kCircleChevronLeftIcon, ['chevron', 'left', 'arrow', 'circle']),
  LucideIconEntry('circle-chevron-right', kCircleChevronRightIcon, ['chevron', 'right', 'arrow', 'circle']),
  LucideIconEntry('circle-chevron-up', kCircleChevronUpIcon, ['chevron', 'up', 'arrow', 'circle']),
  LucideIconEntry('circle-dashed', kCircleDashedIcon, ['circle', 'dashed', 'dotted', 'loading']),
  LucideIconEntry('circle-dollar-sign', kCircleDollarSignIcon, ['dollar', 'money', 'currency', 'circle']),
  LucideIconEntry('circle-help', kCircleHelpIcon, ['help', 'question', 'support', 'circle']),
  LucideIconEntry('clap', kClapIcon, ['clap', 'applause', 'hands', 'cheer']),
  LucideIconEntry('clipboard-check', kClipboardCheckIcon, ['clipboard', 'check', 'task', 'done']),
  LucideIconEntry('clock', kClockIcon, ['clock', 'time', 'watch', 'hour']),
  LucideIconEntry('cloud-cog', kCloudCogIcon, ['cloud', 'cog', 'settings', 'gear']),
  LucideIconEntry('cloud-download', kCloudDownloadIcon, ['cloud', 'download', 'save', 'arrow']),
  LucideIconEntry('cloud-lightning', kCloudLightningIcon, ['cloud', 'lightning', 'storm', 'thunder']),
  LucideIconEntry('cloud-rain', kCloudRainIcon, ['cloud', 'rain', 'weather', 'drizzle']),
  LucideIconEntry('cloud-rain-wind', kCloudRainWindIcon, ['cloud', 'rain', 'wind', 'storm']),
  LucideIconEntry('cloud-snow', kCloudSnowIcon, ['cloud', 'snow', 'weather', 'winter']),
  LucideIconEntry('cloud-sun', kCloudSunIcon, ['cloud', 'sun', 'weather', 'partly']),
  LucideIconEntry('cloud-upload', kCloudUploadIcon, ['cloud', 'upload', 'arrow', 'save']),
  LucideIconEntry('coffee', kCoffeeIcon, ['coffee', 'cup', 'tea', 'drink']),
];
