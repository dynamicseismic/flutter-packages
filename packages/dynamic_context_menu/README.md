...
![1-mobile](https://github.com/dynamicseismic/flutter-packages/assets/96958/05cf793e-d848-4244-8685-dab4059e3940)

- Native context menu on iOS, macOS and Linux
- Flutter context menu on Android, Windows and Web

![2-desktop](https://github.com/dynamicseismic/flutter-packages/assets/96958/858b559a-9674-4bd0-a167-812e304b0c7d)
...
![3-mobile](https://github.com/dynamicseismic/flutter-packages/assets/96958/61cd9630-28e9-47b9-b50b-9df53800e2de)

## Getting started

`dynamic_context_menu` uses Rust internally to implement low-level platform specific functionality.
...
Example project is available at `dynamic_context_menu/example`.
...
After this you can open the folder in VSCode and run the `dynamic_context_menu_example` launcher configuration.
