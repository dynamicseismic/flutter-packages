package io.github.dynamicseismic.dynamic_native_extensions;
 ...
 */
public class DynamicNativeExtensionsPlugin implements FlutterPlugin {
    ...
    static {
        System.loadLibrary("dynamic_native_extensions");
    }
}
