  ...
  if (Platform.environment.containsKey('FLUTTER_TEST')) {
    ...
    final function =
        dylib.lookup<NativeFunction<MessageChannelContextInitFunction>>(
            "dynamic_native_extensions_init_message_channel_context");
...
DynamicLibrary openNativeLibrary() {
  final dylib = Platform.isAndroid
      ? DynamicLibrary.open("libdynamic_native_extensions.so")
      : (Platform.isWindows
          ? DynamicLibrary.open("dynamic_native_extensions.dll")
