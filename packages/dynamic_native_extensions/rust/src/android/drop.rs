...
pub extern "C" fn Java_io_github_dynamicseismic_dynamic_1native_1extensions_DragDropHelper_updateLastTouchPoint<
    'a,
>(
    mut env: JNIEnv<'a>,
    _class: JClass,
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn Java_io_github_dynamicseismic_dynamic_1native_1extensions_DragDropHelper_onDrag<'a>(
    mut env: JNIEnv<'a>,
    _class: JClass,
    event: JObject<'a>,
    drag_context: jlong,
