...
pub extern "C" fn Java_io_github_dynamicseismic_dynamic_1native_1extensions_DataProvider_getAllMimeTypesForURI(
    mut env: JNIEnv,
    _this: JClass,
    uri_string: JString,
    filter: JString,
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "C" fn Java_io_github_dynamicseismic_dynamic_1native_1extensions_DataProvider_getDataForURI(
    mut env: JNIEnv,
    this: JClass,
    uri_string: JString,
    mime_type: JString,
