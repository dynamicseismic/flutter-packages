...
#[no_mangle]
pub extern "C" fn dynamic_native_extensions_text_input_plugin_cut() -> bool {
...
#[no_mangle]
pub extern "C" fn dynamic_native_extensions_text_input_plugin_copy() -> bool {
    let mut handled = false;
    let managers = managers();
    for manager in managers {
        let done = Rc::new(Cell::new(None));
...
#[no_mangle]
pub extern "C" fn dynamic_native_extensions_text_input_plugin_paste() -> bool {
    let mut handled = false;
    let managers = managers();
    for manager in managers {
        let done = Rc::new(Cell::new(None));
...
#[no_mangle]
pub extern "C" fn dynamic_native_extensions_text_input_plugin_select_all() -> bool {
    let mut handled = false;
    let managers = managers();
    for manager in managers {
        let done = Rc::new(Cell::new(None));
