...
pub extern "C" fn dynamic_native_extensions_init() {
    init(true);
}
...
mod android {
    ...
    pub extern "C" fn Java_io_github_dynamicseismic_dynamic_1native_1extensions_DynamicNativeExtensionsPlugin_init(
        env: jni::JNIEnv,
...
#[no_mangle]
pub extern "C" fn dynamic_native_extensions_init_message_channel_context(
    data: *mut c_void,
) -> FunctionResult {
